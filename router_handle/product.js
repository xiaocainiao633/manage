...
exports.editProduct = (req, res) => {
	...
	const product_all_price = product_in_warehouse_number * 1 * product_single_price * 1
	const sql =
...
exports.returnProductListData = (req, res) => {
	...
	// const sql = 
	// `select * from product where product_out_status = NULL ORDER BY product_create_time limit 10 offset ${number} `
	// db.query(sql,(err,result) => {
	// 	if(err) return res.cc(err)
	// 	res.send(result)
	// })
...
exports.returnApplyProductListData = (req, res) => {
	...
	// const sql =
	// `select * from product where product_out_status not in ("NULL") ORDER BY product_apply_time limit 10 offset ${number} `
	// db.query(sql,(err,result) => {
	// 	if(err) return res.cc(err)
	// 	res.send(result)
	// })
