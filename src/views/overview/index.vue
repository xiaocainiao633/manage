		...
		<div class="top-content-wrapped">
			...
			<div class="person-info">
				...
				<div class="detail-info-wrapped">
					...
					<p v-if="userData.name=='小菜鸟'">分管领域：超级管理</p>
					<p v-if="userData.identity=='超级管理员'">权限：最高权限</p>
					<p v-if="userData.identity==('用户管理员'||'产品管理员'||'消息管理员')">权限：中等权限</p>
					<p v-if="userData.identity=='用户'">权限：无权限</p>
				</div>
			</div>
